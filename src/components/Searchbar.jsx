...
export default function SearchBar({
  ...
  // filtro promo (gestito dal parent)
  onlyPromo = false,
  onOnlyPromoChange = () => {},
}) {
  ...
  // “tutte le categorie” => svuota l’array
  const handleAllCategoriesToggle = () => {
    onCategoriesChange([]);
  };

  // toggle filtro promo dal bottone “Promo”
  const handlePromoClick = () => {
    onOnlyPromoChange(!onlyPromo);
  };
  ...
  return (
    <section className="searchbar-wrapper">
      ...
      <div className="search-row search-sort-row">
        ...
        <button
          type="button"
          className={`sort-button promo-sort-button ${
            onlyPromo ? "is-active" : ""
          }`}
